...
import com.adefitri.posyandu.activity.gizi.ProfilGizi;
import com.adefitri.posyandu.activity.login.SessionManager;

public class ProfilKader extends AppCompatActivity {
    TextView tvIdLoginPetugas, tvNamaPetugas, tvUsernamePetugas;
    Button btnLogout;
    SessionManager sm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profil_kader);

        //inisialisasi
        tvIdLoginPetugas    = findViewById(R.id.tv_id_login_petugas);
        tvUsernamePetugas   = findViewById(R.id.tv_username_kader);
        ...
        btnLogout.setOnClickListener(v -> {
            AlertDialog.Builder dialogPesan = new AlertDialog.Builder(ProfilKader.this);
    ...
    public void EditAkunPetugas (View view){
        ...
        String UsernameKader    = data.getStringExtra("username");

        Intent goInput = new Intent(ProfilKader.this, FormAkunKader.class);
        goInput.putExtra("id_petugas", IdLoginPetugas);
        goInput.putExtra("nama_petugas", NamaPetugas);
        goInput.putExtra("username", UsernameKader);
