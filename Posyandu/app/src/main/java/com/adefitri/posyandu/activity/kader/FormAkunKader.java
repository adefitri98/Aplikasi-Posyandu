...
public class FormAkunKader extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_akun_kader);
        ...
        btnEdit.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(passwordBaru)) {
                etPasswordBaru.setError("Tidak Boleh Kosong");
                etPasswordBaru.requestFocus();
                return;
            }

            AlertDialog.Builder dialogPesan = new AlertDialog.Builder(FormAkunKader.this);
    ...
    public void SimpanPerubahan(int IdLoginPetugas, String namaPetugas, String usernamePetugas,
                                String passwordBaru){
        ...
        tampilData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                if (kode == 1) {
                    ...
                    Toast.makeText(FormAkunKader.this, ""+pesan, Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(FormAkunKader.this, "Cek Koneksi Internet", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
