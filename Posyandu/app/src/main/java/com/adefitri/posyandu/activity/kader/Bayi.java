...
public class Bayi extends AppCompatActivity implements SearchView.OnQueryTextListener {
    private RecyclerView rvData;
    private RecyclerView.Adapter adData;
    private List<DataModel> listBayi = new ArrayList<>();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.add :
                ...
                Intent intent = new Intent(Bayi.this, FormBayi.class);
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        Call<ResponseModel> tampilData = ardData.ardReadBayiSearch(newText);
        ...
        tampilData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                if (kode == 1) {
                    listBayi = response.body().getData();
                    adData = new AdapterBayi(Bayi.this, listBayi);
            ...
            public void onFailure(Call<ResponseModel> call, Throwable t) {
                Toast.makeText(Bayi.this, "Cek Koneksi Internet", Toast.LENGTH_SHORT).show();
                pbData.setVisibility(View.INVISIBLE);
            }
        });
        return true;
    ...
    public void semuaBayi() {
        pbData.setVisibility(View.VISIBLE);
        APIRequestData ardData = RetroServer.konekRetrofit().create(APIRequestData.class);
        Call<ResponseModel> tampilData = ardData.ardReadBayi();
